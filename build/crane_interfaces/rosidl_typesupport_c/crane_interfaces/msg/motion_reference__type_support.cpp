...
#include "crane_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _MotionReference_type_support_symbol_names_t _MotionReference_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crane_interfaces, msg, MotionReference)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crane_interfaces, msg, MotionReference)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_crane_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, crane_interfaces, msg, MotionReference)() {
  return &::crane_interfaces::msg::rosidl_typesupport_c::MotionReference_message_type_support_handle;
}
